...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).marked =
        t());
})(this, function () {
  "use strict";
  function r(e, t) {
  ...
  function k(e, t) {
    F[" " + e] ||
      (A.test(e) ? (F[" " + e] = e + "/") : (F[" " + e] = E(e, "/", !0)));
    var u = -1 === (e = F[" " + e]).indexOf(":");
  ...
  var x = function (e, t) {
      ...
      } else if (l.test(e)) return e.replace(a, u);
      return e;
    },
    m = h,
    b = function (u, e) {
      ...
      var n = {
        replace: function (e, t) {
          return (
            (t = (t = t.source || t).replace(p, "$1")), (u = u.replace(e, t)), n
          );
        },
        getRegex: function () {
    ...
    B = function (e, t, u) {
      if (e) {
        var n;
        try {
          n = decodeURIComponent(h(u)).replace(f, "").toLowerCase();
        } catch (e) {
          return null;
        }
        if (
  ...
  function O(e, t, u, n) {
    var r = t.href,
      ...
      t = e[1].replace(/\\([\[\]])/g, "$1");
    if ("!" === e[0].charAt(0))
      return { type: "image", raw: u, href: r, title: i, text: Z(t) };
    n.state.inLink = !0;
    t = {
      type: "link",
      raw: u,
    ...
    return (
      ...
      (t.fences = function (e) {
        ...
        if (t) {
          ...
          return { type: "code", raw: u, lang: t[2] && t[2].trim(), text: e };
        }
      }),
      (t.heading = function (e) {
        ...
        if (t) {
          ...
          /#$/.test(u) &&
            ((e = R(u, "#")),
            (!this.options.pedantic && e && !/ $/.test(e)) || (u = e.trim()));
          u = {
            type: "heading",
            raw: t[0],
            depth: t[1].length,
      ...
      (t.list = function (e) {
        ...
        if (t) {
          ...
          for (
            ...
            (o = t[2].split("\n")),
              (D = this.options.pedantic
                ? ((i = 2), o[0].trimLeft())
                : ((i = t[2].search(/[^ ]/)),
                  (i = t[1].length + (4 < i ? 1 : i)),
                  o[0].slice(i - t[1].length))),
              (s = !1),
              (u = t[0]),
              !o[0] &&
                /^ *$/.test(o[1]) &&
                ((u = t[1] + o.slice(0, 2).join("\n") + "\n"),
                (h.loose = !0),
                (o = []));
            for (
              var g = new RegExp(
          ...
          (h.items[h.items.length - 1].raw = u.trimRight()),
            (h.items[h.items.length - 1].text = D.trimRight()),
            (h.raw = h.raw.trimRight());
          var A = h.items.length;
          for (F = 0; F < A; F++)
            (this.lexer.state.top = !1),
              (h.items[F].tokens = this.lexer.blockTokens(h.items[F].text, [])),
              h.items[F].tokens.some(function (e) {
                return "space" === e.type;
              }) && ((h.loose = !0), (h.items[F].loose = !0));
          return h;
        }
      }),
      (t.html = function (e) {
        ...
        if (e) {
          ...
          if (t.header.length === t.align.length) {
            ...
            for (i = t.rows.length, s = 0; s < i; s++)
              t.rows[s] = I(t.rows[s], t.header.length).map(function (e) {
                return { text: e };
              });
            for (i = t.header.length, u = 0; u < i; u++)
              (t.header[u].tokens = []),
                this.lexer.inlineTokens(t.header[u].text, t.header[u].tokens);
            for (i = t.rows.length, u = 0; u < i; u++)
              for (r = t.rows[u], n = 0; n < r.length; n++)
                (r[n].tokens = []),
                  this.lexer.inlineTokens(r[n].text, r[n].tokens);
            return t;
          }
        }
      }),
      ...
      (t.link = function (e) {
        ...
        if (t) {
          ...
          if (!this.options.pedantic && /^</.test(u)) {
            ...
            var n = q(t[2], "()");
            -1 < n &&
              ((i = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + n),
      ...
      (t.emStrong = function (e, t, u) {
        ...
        if (
          ...
          if (!r || "" === u || this.rules.inline.punctuation.exec(u)) {
            ...
            for (
              o.lastIndex = 0, t = t.slice(-1 * e.length + s);
              null != (n = o.exec(t));
      ...
      (t.codespan = function (e) {
        ...
        if (t) {
          var u = t[2].replace(/\n/g, " "),
            ...
            e = /^ /.test(u) && / $/.test(u);
          return (
            n && e && (u = u.substring(1, u.length - 1)),
            (u = Z(u, !0)),
      ...
      (t.autolink = function (e, t) {
        ...
        if (e) {
          var u,
            t =
              "@" === e[2]
                ? "mailto:" + (u = Z(this.options.mangle ? t(e[1]) : e[1]))
                : (u = Z(e[1]));
          return {
            type: "link",
            raw: e[0],
      ...
      (t.url = function (e, t) {
        ...
        if ((u = this.rules.inline.url.exec(e))) {
          if ("@" === u[2])
            r = "mailto:" + (n = Z(this.options.mangle ? t(u[0]) : u[0]));
          else {
            for (
              ;
              (i = u[0]),
          ...
          t = this.lexer.state.inRawBlock
            ? this.options.sanitize
              ? this.options.sanitizer
                ...
                : Z(e[0])
              : e[0]
            : Z(this.options.smartypants ? t(e[0]) : e[0]);
  ...
  (b.def = z(b.def)
    ...
    (b.pedantic = w({}, b.normal, {
      ...
      heading: /^(#{1,6})(.*)(?:\n+|$)/,
      fences: y,
      paragraph: z(b.normal._paragraph)
        .replace("hr", b.hr)
        .replace("heading", " *#{1,6} *[^\n]")
  ...
  (y.punctuation = z(y.punctuation)
    .replace(/punctuation/g, y._punctuation)
    .getRegex()),
    (y.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (y.escapedEmSt = /\\\*|\\_/g),
    (y._comment = z(b._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
    (y.emStrong.lDelim = z(y.emStrong.lDelim)
      .replace(/punct/g, y._punctuation)
      .getRegex()),
    (y.emStrong.rDelimAst = z(y.emStrong.rDelimAst, "g")
      .replace(/punct/g, y._punctuation)
      .getRegex()),
    (y.emStrong.rDelimUnd = z(y.emStrong.rDelimUnd, "g")
      .replace(/punct/g, y._punctuation)
      .getRegex()),
    (y._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (y.link = z(y.link)
      ...
      .getRegex()),
    (y.reflink = z(y.reflink).replace("label", y._label).getRegex()),
    (y.reflinkSearch = z(y.reflinkSearch, "g")
      .replace("reflink", y.reflink)
      .replace("nolink", y.nolink)
      .getRegex()),
    (y.normal = w({}, y)),
    (y.pedantic = w({}, y.normal, {
      strong: {
        start: /^__|\*\*/,
        middle:
    ...
    (y.gfm = w({}, y.normal, {
      escape: z(y.escape).replace("])", "~|])").getRegex(),
      _extended_email:
    ...
    (y.gfm.url = z(y.gfm.url, "i")
      .replace("email", y.gfm._extended_email)
      .getRegex()),
    (y.breaks = w({}, y.gfm, {
      br: z(y.br).replace("{2,}", "*").getRegex(),
      text: z(y.gfm.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
    }));
  var b = { block: b, inline: y },
    j = _,
    L = t.exports.defaults,
    Q = b.block,
    U = b.inline,
    P = S;
  function M(e) {
  ...
  var y = (function () {
      function u(e) {
        ...
        e = { block: Q.normal, inline: U.normal };
        this.options.pedantic
          ? ((e.block = Q.pedantic), (e.inline = U.pedantic))
          : this.options.gfm &&
            ((e.block = Q.gfm),
            this.options.breaks ? (e.inline = U.breaks) : (e.inline = U.gfm)),
      ...
      return (
        ...
        (n.blockTokens = function (r, t) {
          ...
          for (
            void 0 === t && (t = []),
              this.options.pedantic && (r = r.replace(/^ +$/gm, ""));
            r;
            ...
            if (
              ...
              if ((u = this.tokenizer.space(r)))
                (r = r.substring(u.raw.length)), u.type && t.push(u);
              ...
              if ((u = this.tokenizer.escape(r)))
                ...
                (r = r.substring(u.raw.length)),
                  ...
                  "text" === e.type
                    ? ((e.raw += u.raw), (e.text += u.text))
                    : t.push(u);
              else if ((u = this.tokenizer.emStrong(r, o, a)))
                (r = r.substring(u.raw.length)), t.push(u);
                ...
                (r = r.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.autolink(r, N)))
                (r = r.substring(u.raw.length)), t.push(u);
              else if (this.state.inLink || !(u = this.tokenizer.url(r, N))) {
                if (
                  ((i = r),
                  this.options.extensions &&
                  ...
                  (u = this.tokenizer.inlineText(i, M)))
                )
                  (r = r.substring(u.raw.length)),
        ...
        (t.code = function (e, t, u) {
          ...
          return (
            !this.options.highlight ||
              (null != (t = this.options.highlight(e, n)) &&
                t !== e &&
                ((u = !0), (e = t))),
            (e = e.replace(/\n$/, "") + "\n"),
            n
              ...
              switch (o.type) {
                ...
                case "heading":
                  C += this.renderer.heading(
                    ...
                    o.depth,
                    Y(this.parseInline(o.tokens, this.textRenderer)),
                    this.slugger
                  );
                  continue;
                case "code":
                  C += this.renderer.code(o.text, o.lang, o.escaped);
                  continue;
                case "table":
                  ...
                  C += this.renderer.table(D, a);
                  continue;
                case "blockquote":
                  (a = this.parse(o.tokens)),
                    (C += this.renderer.blockquote(a));
                  continue;
                case "list":
                  for (
                    D = o.ordered,
                  ...
                  C += this.renderer.list(a, D, E);
                  continue;
                case "html":
                  C += this.renderer.html(o.text);
                  continue;
                case "paragraph":
                  C += this.renderer.paragraph(this.parseInline(o.tokens));
                  continue;
                case "text":
                  for (
                    a = o.tokens ? this.parseInline(o.tokens) : o.text;
                    k + 1 < d && "text" === e[k + 1].type;
  ...
  function ae(e, u, n) {
    ...
    if (
      ...
      var s = function (t) {
        ...
        if (!t)
          try {
            u.walkTokens && ae.walkTokens(r, u.walkTokens),
              (e = te.parse(r, u));
          } catch (e) {
            t = e;
          }
    ...
    try {
      var t = ee.lex(e, u);
      return u.walkTokens && ae.walkTokens(t, u.walkTokens), te.parse(t, u);
    } catch (e) {
      if (
        ((e.message +=
  ...
  return (
    ...
    (ae.use = function () {
      for (
        var u = this, e = arguments.length, t = new Array(e), n = 0;
        n < e;
        n++
      )
        t[n] = arguments[n];
      var r,
        ...
        s = ae.defaults.extensions || { renderers: {}, childTokens: {} };
      t.forEach(function (l) {
        var t;
        l.extensions &&
          ((r = !0),
          l.extensions.forEach(function (r) {
            if (!r.name) throw new Error("extension name required");
            var i;
            if (
              (r.renderer &&
                ((i = s.renderers ? s.renderers[r.name] : null),
                (s.renderers[r.name] = i
                  ? function () {
                      for (
              ...
              s[r.level]
                ? s[r.level].unshift(r.tokenizer)
                : (s[r.level] = [r.tokenizer]),
                r.start &&
                  ("block" === r.level
                    ? s.startBlock
                      ? s.startBlock.push(r.start)
                      : (s.startBlock = [r.start])
                    : "inline" === r.level &&
                      (s.startInline
                        ? s.startInline.push(r.start)
                        : (s.startInline = [r.start])));
            }
          ...
          l.tokenizer &&
            (function () {
              var e,
                s = ae.defaults.tokenizer || new ue();
              for (e in l.tokenizer)
                !(function (r) {
                  var i = s[r];
                  s[r] = function () {
                    for (
    ...
    (ae.walkTokens = function (e, l) {
      for (var a, t = o(e); !(a = t()).done; )
        !(function () {
          ...
          switch ((l(t), t.type)) {
            case "table":
              for (var e = o(t.header); !(u = e()).done; ) {
                var u = u.value;
                ae.walkTokens(u.tokens, l);
              }
              for (var n, r = o(t.rows); !(n = r()).done; )
                for (var i = o(n.value); !(s = i()).done; ) {
                  var s = s.value;
                  ae.walkTokens(s.tokens, l);
                }
              break;
            case "list":
              ae.walkTokens(t.items, l);
              break;
            default:
              ae.defaults.extensions &&
              ae.defaults.extensions.childTokens &&
              ae.defaults.extensions.childTokens[t.type]
                ? ae.defaults.extensions.childTokens[t.type].forEach(function (
                    e
                  ) {
                    ae.walkTokens(t[e], l);
                  })
    ...
    (ae.parseInline = function (e, t) {
      ...
      (t = re({}, ae.defaults, t || {})), ie(t);
      try {
        var u = ee.lexInline(e, t);
        return (
          t.walkTokens && ae.walkTokens(u, t.walkTokens), te.parseInline(u, t)
        );
      } catch (e) {
        if (
          ((e.message +=
